...
import com.admin.exception.shiro.PrincipalIdNullException;
import com.admin.exception.shiro.PrincipalInstanceException;
    ...
    private String getRedisKeyFromPrincipalIdField(PrincipalCollection key) {
        ...
        for (Method m : methods) {
            if (RedisCacheManager.DEFAULT_PRINCIPAL_ID_FIELD_NAME.equals(this.principalIdFieldName)
                    && ("getAuthCacheKey".equals(m.getName()) || "getUid".equals(m.getName()))) {
                pincipalIdGetter = m;
                break;
            }
